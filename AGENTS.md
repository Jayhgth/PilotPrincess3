...
- Codex is opt-in and follows `docs/AI_TRANSPARENCY.md`: retrieve only curated app guidance, use one persistent global chat, show readable work, and run allowlisted reads automatically. Every write starts as an exact proposal routed through Manual or a separate Auto-review; destructive, identity-sensitive, grade-changing, and high-risk changes stay manual. Never expose hidden chain-of-thought.
