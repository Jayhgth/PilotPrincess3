...
- Codex is opt-in and follows `docs/AI_TRANSPARENCY.md`: retrieve only curated app guidance, use one persistent global chat, show readable work, run allowlisted reads automatically, and require exact confirmation before every write; never expose hidden chain-of-thought.
