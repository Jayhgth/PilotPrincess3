...
Associate-degree discovery uses one search field rather than stacked mode, award, and college filters. Degrees appear as equal-size cards in a horizontal rail; students mark any number with a red bookmark, with no artificial primary-degree rank. Major requirements stay attached to the selected degree and use full-row completed, planned, partial, and missing tinting. General education is one shared audit because every AA and AS includes a GE pattern, but its exact 2025-2026 areas and units follow the selected awarding college. Course eligibility comes from each source college's complete official worksheet and follows district reciprocity across Cañada, CSM, and Skyline. The audit assigns a course to only one local GE area unless an official statutory requirement permits reuse, and always shows missing areas, including oral communication/critical thinking, laboratory conditions, and the Area 7 physical-activity minimum.
