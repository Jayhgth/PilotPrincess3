  ...
  return <div className={`${styles.setup} ${compact ? styles.compact : ""}`}>
    ...
    {value.enabled && <FadeContent className={styles.connectionDetails} duration={0.16}>
      ...
      <label className={styles.consent}>
        ...
        <ShieldCheck size={18} />
        <span>I approve sending my messages, retrieved app guidance, and the student records needed for my request to OpenAI Codex. Every saved change still requires a separate confirmation.</span>
      </label>
