...
values
  ...
  ('d7ec0000-0000-4000-8000-000000000001', 'd7ec2000-0000-4000-8000-000000000001', 'd7ec1000-0000-4000-8000-000000000001', 'social_science', 'Social Science', 30, 3, 'World History, US History, and the full-year Government & Economics course are required. Ethnic Studies does not replace one of these three areas.', 'verified', 'approved'),
...
values
  ...
  ('d7ec0000-0000-4000-8000-000000000001','d7ec2000-0000-4000-8000-000000000001','d7ec1000-0000-4000-8000-000000000002','Government & Economics','Social Science',array[12],10,'year','A/G (History and College Preparatory Elective)',array[]::text[],'Full-year senior course covering government, the Constitution, federalism, elections, civil rights, economic systems, markets, public policy, and personal finance.',false,false,'verified','approved'),
  ...
  ('d7ec0000-0000-4000-8000-000000000001','d7ec2000-0000-4000-8000-000000000001','d7ec1000-0000-4000-8000-000000000002','Calculus / Calculus Honors','Mathematics',array[11,12],10,'year','C (Mathematics)',array['Precalculus'],'Full-year limits, derivatives, integrals, optimization, related rates, differential equations, area, and volume. For sequence planning this is Calculus I level, equivalent to the MATH 251 position in the math ladder; it does not award college credit or satisfy a college degree requirement without separate articulation evidence.',true,true,'verified','approved'),
