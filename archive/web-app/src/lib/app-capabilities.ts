...
export const APP_CAPABILITY_REGISTRY = {
  ...
  get_plan_versions: { capabilities: ["history", "schedule"], ...READ_ONLY },
  compare_plan_versions: { capabilities: ["history", "schedule", "graduation", "gpa", "degree"], ...READ_ONLY },
  ...
  search_college_programs: { capabilities: ["degree", "college"], ...READ_ONLY },
  ...
  add_course_schedule: { capabilities: ["schedule"], affects: ["history", "plan", "graduation", "gpa", "college", "enrollment"], review: "deterministic" },
  ...
  update_plan_courses: { capabilities: ["courses", "schedule", "gpa"], affects: ["history", "plan", "graduation", "gpa", "college", "enrollment"], review: "deterministic" },
  ...
  correct_transcript_course: { capabilities: ["transcript"], affects: ["transcript", "plan", "graduation", "gpa", "college"], review: "deterministic" },
  ...
  create_plan_version: { capabilities: ["history", "schedule"], affects: ["history", "active_plan", "plan", "graduation", "gpa", "college", "degree", "enrollment"], review: "deterministic" },
  merge_plan_versions: { capabilities: ["history", "schedule"], affects: ["history", "plan", "graduation", "gpa", "college", "degree", "enrollment"], review: "deterministic" },
  activate_plan_version: { capabilities: ["history", "schedule"], affects: ["history", "active_plan", "plan", "graduation", "gpa", "college", "degree", "enrollment"], review: "deterministic" },
  rename_plan_version: { capabilities: ["history", "schedule"], affects: ["history"], review: "deterministic" },
  archive_plan_version: { capabilities: ["history", "schedule"], affects: ["history"], review: "deterministic" },
  set_smccd_ge_completion: { capabilities: ["degree", "college"], affects: ["degree"], review: "deterministic" },
  ...
  clear_college_goal: { capabilities: ["degree", "college"], affects: ["degree"], review: "deterministic" },
  clear_academic_plan: { capabilities: ["schedule", "degree", "gpa"], affects: ["history", "plan", "graduation", "gpa", "degree", "enrollment"], review: "deterministic" }
...
export function pilotCapabilitiesForMessage(userMessage: string): PilotCapability[] {
  ...
  if (includesAny(value, [/undo/, /revert/, /restore/, /bring.*back/, /snapshot/, /history/, /plan version/, /alternate plan/, /another plan/, /new plan/, /switch.*plan/, /compare.*plan/, /rename.*plan/, /delete.*plan/, /backup/])) capabilities.add("history");
