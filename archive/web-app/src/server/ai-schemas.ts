...
const assistantToolNames = [
  ...
  // Retained for replaying older persisted turns. New prompts receive the
  // provider-neutral search_college_programs contract.
  "search_smccd_programs",
  "set_current_school",
  "set_college_district_preference",
  "undo_change",
  "add_course_schedule",
  "add_dtech_course",
